...
class OutOfBoundsException(Exception):
    def __init__(self, message="Índice além do tamanho da lista."):
...
class LinkedList(object):
    ...
    def head(self):
        ...
        if self._head:
            ...
            print('Não é possível retornar o primeiro nó')
            return None
    ...
    def tail(self):
        ...
        if self._tail:
            ...
            print('Não é possível retornar o último nó')
            return None
    ...
    def removeFirst(self):
        ...
        """
        if self._head is None:
            raise Exception("Lista vazia, não é possível remover o primeiro elemento")
    ...
    def getValueAt(self, index):
        ...
        """
        if index >= self._len or (index * (-1)) >= self._len:
            raise OutOfBoundsException()
        
        if index < 0 and (index * (-1)) < self._len:
